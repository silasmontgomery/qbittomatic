...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    startFetching: function startFetching() {
      ...
      this.fetchPaths();
      this.fetchApis();
      window.fetchInterval = window.setInterval(function (f) {
        _this.fetchTorrents();
      }, 1000);
    },
    fetchTorrents: function fetchTorrents() {
      ...
      axios.get('/torrent').then(function (response) {
    ...
    fetchPaths: function fetchPaths() {
      ...
      axios.get('/paths').then(function (response) {
    ...
    fetchApis: function fetchApis() {
      ...
      axios.get('/search_apis').then(function (response) {
    ...
    onRemoveTorrentClick: function onRemoveTorrentClick(torrent) {
      ...
      axios["delete"]('/torrent/' + torrent.hash + '?deleteFiles=' + (this.deleteFiles.find(function (t) {
        return t.hash == torrent.hash;
    ...
    onSearch: function onSearch() {
      ...
      this.searching = true;
      axios.get('/search?api=' + this.api + '&q=' + this.search).then(function (response) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "flex m-3" }, [
    _c("div", { staticClass: "flex-grow text-gray-600 text-xl" }, [
      _vm._v("qBittomatic")
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "flex-grow text-right" }, [
      _c("div", [
        _c(
          "a",
          {
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("div", { staticClass: "bg-white shadow-md rounded p-5 mb-3" }, [
      _c("div", { staticClass: "scrolling-touch overflow-auto" }, [
        _c("table", { staticClass: "table-auto text-left w-full" }, [
          _vm._m(0),
          _vm._v(" "),
          _c(
            "tbody",
                ...
                return [
                  _c(
                    "tr",
                    {
                      key: torrent.hash + "A",
                      staticClass:
                        "odd:bg-gray-200 hover:cursor-pointer hover:bg-gray-300",
                      on: {
                        click: function($event) {
                  ...
                  _c(
                    "tr",
                    {
                      ...
                      ref: torrent.hash,
                      refInFor: true,
                      staticClass: "odd:bg-gray-200 hidden"
                    },
                    [
                          ...
                          _c("div", { staticClass: "flex-grow" }, [
                            ...
                            _c(
                              "select",
                              {
                                ...
                                staticClass:
                                  "form-select focus:outline-none focus:bg-white focus:border-gray-500",
                                on: {
                                  change: [
                                    function($event) {
    ...
    _c(
      "div",
      { staticClass: "bg-white shadow-md rounded px-3 py-3 mb-3 text-center" },
      [
        _c(
          "select",
          {
    ...
    _vm.results && _vm.results.length > 0
      ? _c("div", { staticClass: "bg-white shadow-md rounded p-5 mb-2" }, [
          _c("div", { staticClass: "scrolling-touch overflow-auto" }, [
            _c("table", { staticClass: "table-auto w-full text-left" }, [
              _vm._m(1),
              _vm._v(" "),
              _c(
                "tbody",
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "mt-10 mx-auto w-full max-w-xs" }, [
    _c(
      "p",
      { staticClass: "font-sans text-2xl text-gray-600 text-center mb-2" },
      [_vm._v("\n    qBittomatic\n  ")]
    ),
    _vm._v(" "),
    _c(
      ...
      [
        _c("div", { staticClass: "mb-4" }, [
          ...
          _c("input", {
            ...
            ref: "email",
            staticClass:
              "form-input w-full focus:outline-none focus:shadow-outline",
          ...
          _vm._v(" "),
          _vm.errors.email
            ? _c("p", { staticClass: "text-red-500 text-xs italic my-3" }, [
        ...
        _c("div", { staticClass: "flex items-center justify-between" }, [
          _c(
            ...
            {
              staticClass:
                "btn btn-blue focus:outline-none focus:shadow-outline",
              attrs: { type: "button" },
    ...
    _c("p", { staticClass: "text-center text-gray-500 text-xs" }, [
      _vm._v("\n    © 2019 qBittomatic. All rights reserved.\n  ")
    ])
  ])
}
var staticRenderFns = []
...
// Config Options
var baseUrl = '/api/v1';
var cookieExpiration = '1d'; // Requirements




vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]);
vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_cookies__WEBPACK_IMPORTED_MODULE_2___default.a); // Vue Cookies Setup

vue_cookies__WEBPACK_IMPORTED_MODULE_2___default.a.config(cookieExpiration); // Axios Setup

window.axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
window.axios.defaults.headers.common['X-Requested-With'] = 'XMLHttpRequest';
window.axios.defaults.baseURL = baseUrl;
window.fetchInterval = null; // View single file components (views)



 // Reusable components

vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('menu-component', __webpack_require__(/*! ./components/menu.vue */ "./resources/js/components/menu.vue")["default"]);
var routes = [{
  path: '/dashboard',
  name: 'dashboard',
...
module.exports = __webpack_require__(/*! /var/www/qbittomatic/resources/css/app.css */"./resources/css/app.css");
